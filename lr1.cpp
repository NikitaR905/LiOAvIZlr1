...
void nozero(int** m, int rows, int cols) {
    int sum = 0;
    int n = 0;
    for (int i = 0; i < rows; i++) {
    ...
    printf("сумма всех %d ненулевых значений находящихся на и ниже главной диагонали: %d\n", n, sum);
...
int main(void)
{
    ...
    while (1) {
        ...
        case 8: nozero(m, rows, cols); break;
        case 9: if (d != NULL) {free(d); d = NULL;}; return 0;
        default:
